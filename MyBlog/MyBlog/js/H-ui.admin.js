...
function admin_del(obj, id) {
    layer.confirm('确认要删除吗？', function (index) {
        $.post("/Admin/Account/Delete/" + id, {}, function (data) {
            $(obj).parents("tr").remove();
            layer.msg('已删除!', 1);
        });
    });
...
function admin_stop(obj, id) {
    $.post("/FwAdmin/Account/ChangeShow/" + id, {}, function (data) {
        $(obj).parents("tr").find(".admin-manage").prepend('<a style="text-decoration:none" onClick="admin_start(this,' + id + ')" href="javascript:;" title="启用"><i class="icon-hand-up"></i></a>');
...
function admin_start(obj, id) {
    $.post("/FwAdmin/Account/ChangeShow/" + id, {}, function (data) {
        $(obj).parents("tr").find(".admin-manage").prepend('<a style="text-decoration:none" onClick="admin_stop(this,' + id + ')" href="javascript:;" title="停用"><i class="icon-hand-down"></i></a>');
